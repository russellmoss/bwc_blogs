...
this topic.`}
          ...
          <section id="step-6" className="gs-step-section">
            ...
            <div className="gs-step-body">
              ...
              <p><strong>Editing Hyperlinks in Canvas</strong> — The AI does a good job with links, but it can occasionally get them wrong — a URL might be outdated, point to the wrong page, or simply not be relevant. It&#39;s a good habit to scan through the hyperlinks in a generated article before finalizing. In Canvas mode, simply <strong>highlight any hyperlinked text</strong> and a toolbar will appear. From there you can <strong>edit the URL</strong> to fix it, or <strong>remove the link entirely</strong> if it&#39;s not needed. You can also highlight any plain text and add a new link to it the same way.</p>
